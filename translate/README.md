...
├── MODELS_AND_API.md              # AI models & Ollama Pay guide
...
|-------|----------|----------|-------|
| **Gemma 4** | Ollama Pay | Primary translation | Fast, good Thai quality |
| DeepSeek V3.1 (671B) | Ollama Pay | High-quality translation | Slower but more accurate |
| Claude 3.5 Sonnet | Anthropic API | Premium translation | Best quality, higher cost |

### For Polishing (Gao Fei Style)

| Model | Provider | Use Case | Notes |
|-------|----------|----------|-------|
| **DeepSeek V3.1 (671B)** | Ollama Pay | Gao Fei polish | Excellent literary style |
| Gemma 4 | Ollama Pay | Light polishing | Faster, good for batches |

---

## 🔌 API Providers

### Ollama Pay API (Recommended)

**Endpoint:** `https://ollama-pay.thaigqsoft.com/api/v1`

**Available Models:**
- `gemma4:31b-cloud` — Gemma 4 31B (fast, good for translation)
- `deepseek-v3.1:671b-cloud` — DeepSeek V3.1 671B (best for polishing)

**Setup:**
```bash
# Get API key from: https://ollama-pay.thaigqsoft.com
...
response = client.chat.completions.create(
    model="gemma4:31b-cloud",  # or "deepseek-v3.1:671b-cloud"
    messages=[
...
- [ ] Use Gemma 4 or DeepSeek V3.1 via Ollama Pay API
...
2. Read `MODELS_AND_API.md` — Learn about AI models & Ollama Pay
3. Read `TRANSLATION_WORKFLOW.md` — Learn the full process
4. Study `examples/` — See before/after comparisons
